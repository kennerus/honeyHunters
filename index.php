						...
						<div class="container">
							<div class="row">
								...
								<div class="col-md-12 block__text">
									<a href="mailto:vasya@mail.ru">vasya@mail.ru</a>
									<p>Сообщение от Васи Пупкина</p>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-6 col-12 comments__block even">
						<div class="container">
							<div class="row">
								<div class="col-md-12 block__title">
									<h3>Маруся</h3>
								...
								<div class="col-md-12 block__text">
									<a href="mailto:marusya@mail.ru">marusya@mail.ru</a>
									<p>Всем привет, я Маруся.</p>
								</div>
							</div>
						</div>
					</div>
